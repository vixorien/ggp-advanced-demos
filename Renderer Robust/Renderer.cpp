...
// Specific changes for this demo:
// 
// - Material changes
//   - Material now keeps dictionaries of textures and samplers
//     - One each for VS and PS (4 total)
//     - "string name in shader" -> SRV or Sampler
//   - Added "AddTexture" and "AddSampler"-type methods
//     - One each for PS and VS (4 total)
//     - TODO: Create "Remove" variations, too
//   - Material constructor has changed
//     - Does not require textures or sampler
//   - Added SetPerMaterialDataAndResources() method
// 
// - Renderer changes
//   - Added per-frame constant buffers (ps and vs) and local data buffers
//     - Created during renderer constructor
//     - Set and used during render
//   - Created local (sortable) copy of entities list before drawing
//     - Sorted by material before draw
// 
//
// - Shader changes
//   - Reorganized cbuffers in standard pixel & vertex shaders
//     - Now have perFrame, perMaterial and perObject cbuffers
//     - perFrame is always bound to b0
//
// - Entity changes
//   - Added "SetMaterial" for UI purposes
//
// - Game.cpp changes
//   - Added Entity UI to change transforms and materials
