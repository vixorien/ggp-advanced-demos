...
void Sky::Draw(Camera* camera, DirectX::XMFLOAT4X4 prevView, DirectX::XMFLOAT4X4 prevProj)
{
	...
	skyVS->SetMatrix4x4("prevView", prevView);
	skyVS->SetMatrix4x4("prevProjection", prevProj);
