...
void Game::LoadAssetsAndCreateEntities()
{
	...
	std::shared_ptr<SimpleComputeShader> particleEmitCS				= LoadShader(SimpleComputeShader, L"ParticleEmitCS.cso");
	std::shared_ptr<SimpleComputeShader> particleUpdateCS			= LoadShader(SimpleComputeShader, L"ParticleUpdateCS.cso");
	std::shared_ptr<SimpleComputeShader> particleDeadListInitCS		= LoadShader(SimpleComputeShader, L"ParticleDeadListInitCS.cso");
	std::shared_ptr<SimpleComputeShader> particleCopyDrawCountCS	= LoadShader(SimpleComputeShader, L"ParticleCopyDrawCountCS.cso");
