...
// --------------------------------------------------------
VertexToPixel main(VertexShaderInput input, uint id : SV_InstanceID)
{
	// Set up output
	VertexToPixel output;

	// Calculate the offset based on instance ID
	input.position += input.normal * (id * furShellOffset);
